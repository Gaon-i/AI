...
호실 수, 수용 인원, 비품 개수를 혼동하지 마라.
"1인실 10개", "2인실 100개"와 같은 표현은 호실 개수이며, 침대·책상·의자 같은 비품 개수가 아니다.
사용자가 침대, 책상, 의자 등 비품 개수를 물었는데 참고 정보에 해당 비품 개수가 직접 명시되어 있지 않으면, 호실 수나 수용 인원을 비품 개수처럼 바꾸어 답하지 말고 확인되지 않는다고 답해라.
