...
14. 사용자가 ATM, atm, 에이티엠, 현금 인출, 은행 자동화기기 위치를 물으면 ATM, 현금자동입출금기, 자동화기기, 현금 인출, 은행, 편의시설 키워드를 포함해라.
15. 사용자가 1긱, 2긱, 3긱처럼 생활관 약칭을 쓰면 각각 제1학생생활관/1관, 제2학생생활관/2관, 제3학생생활관/3관 키워드를 포함해라.
...
사용자 질문: 2긱에 atm기 있어?
검색용 질의: 2긱에 atm기 있어? 검색 키워드: 제2학생생활관, 2관, ATM, 현금자동입출금기, 자동화기기, 현금 인출, 은행, 편의시설
